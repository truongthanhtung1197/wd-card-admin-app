...
import { useEditDomainLogic } from "./EditDomain.logic";
          ...
          {(props: FormikProps<any>) => {
            ...
            return (
              <div className="col relative w-full">
                <div className="mb-3 flex flex-col gap-5 rounded-lg border-[0.5px] border-solid border-neutral-stroke-light bg-white p-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FSelectInput
                      ...
                      name="status"
                      isRequired
                      contentLabel={values?.status}
                    />
                  </div>
                </div>

                {/* OLD LOGIC: Manager roles - only team selection */}
                {isManagerRole && (
                  <div className="mb-3 flex flex-col gap-5 rounded-lg border-[0.5px] border-solid border-neutral-stroke-light bg-white p-5">
                ...
                {/* NEW LOGIC: Team Leader roles - team selection only */}
                {isTeamLeaderRole && (
                  <div className="mb-3 flex flex-col gap-5 rounded-lg border-[0.5px] border-solid border-neutral-stroke-light bg-white p-5">
                    <div className="flex items-center justify-between">
