...
function SmsSentIcon() {
  return (
    ...
    >
      ...
      <path
        fill="#AC2125"
        d="M20.1 14.654a.836.836 0 01-.175.275l-2.5 2.5a.836.836 0 01-1.183-1.184l1.083-1.075h-4.658a.833.833 0 010-1.666h4.658l-1.083-1.075a.837.837 0 011.183-1.184l2.5 2.5c.076.08.136.173.175.275a.785.785 0 010 .634z"
      ></path>
    </svg>
  );
}

export default memo(SmsSentIcon);
