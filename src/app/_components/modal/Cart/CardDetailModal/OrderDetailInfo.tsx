    ...
    <>
      <div className="space-y-2">
        <div className="grid grid-cols-3 gap-2 gap-x-[30px]">
          ...
          {service?.isFollowTextLink &&
            serviceType === SERVICE_TYPE.TEXTLINK && (
              <RenderFiledValue filedName={"Follow"} value={"Yes"} />
            )}
          {service?.isHomeTextLink && serviceType === SERVICE_TYPE.TEXTLINK && (
            <RenderFiledValue filedName={"Home"} value={"Yes"} />
          )}
          {service?.isFooterTextLink &&
            serviceType === SERVICE_TYPE.TEXTLINK && (
              <RenderFiledValue filedName={"Footer"} value={"Yes"} />
            )}
          {serviceType === SERVICE_TYPE.CONTENT && (
            <>
          ...
          {quantity && serviceType !== SERVICE_TYPE.CONTENT && (
          ...
          {price && serviceType !== SERVICE_TYPE.CONTENT && (
            <RenderFiledValue
              filedName={"price"}
              value={formatCurrency(price)}
            />
          )}
          {discount && serviceType !== SERVICE_TYPE.CONTENT && (
            <RenderFiledValue
              filedName={"discount"}
          ...
          <div className="rounded-md p-3">
            ...
            <div className="pl-6">
              <ul className="col gap-3">
                {service?.complimentaries?.map((item: any, index: number) => (
